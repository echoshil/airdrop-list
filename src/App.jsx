...
import { Eye, EyeOff, Github, Filter } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 p-6 max-w-6xl mx-auto">
        ...
        {/* ➕ Tambah Project */}
        <div className="bg-gray-800/80 p-4 rounded-lg mb-6 shadow-lg border border-gray-700 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              <input
                ...
                className="p-2 rounded bg-gray-700 text-white w-full focus:ring-2 focus:ring-cyan-400"
              />
            ))}
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {filteredProjects.map((p, i) => (
              <motion.div
                ...
                className="relative bg-gray-800/80 p-4 rounded-lg shadow-lg border border-gray-700 hover:border-cyan-400 transition-all backdrop-blur-md"
              >
