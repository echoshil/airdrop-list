...
import { Eye, EyeOff, Twitter, MessageSquare, Send, Wallet, Mail, Globe, Github } from "lucide-react";
import "./App.css";
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white p-6">
      {/* Header */}
      <h1 className="text-3xl font-bold mb-6 text-center">🚀 Airdrop Tracker Pro</h1>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
        <input
          ...
          className="p-2 rounded bg-gray-800 text-white w-full md:w-1/2 focus:ring-2 focus:ring-cyan-400 outline-none"
        />
      ...
      {filteredProjects.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filteredProjects.map((p, i) => (
            <div
              key={i}
              className="bg-gray-800 p-4 rounded-lg shadow-md relative hover:shadow-cyan-500/30 transition-all"
            >
              {/* Hide/Unhide */}
              <button
